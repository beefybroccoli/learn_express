...
// middleware with an arity of 4 are considered error handling middleware. When you next(err) it will be passed through the defined middleware in order, but ONLY those with an arity of 4, ignoring
// regular middleware.
