...
// middleware with an arity of 4 are considered error handling middleware. When you next(err) it will be passed through the defined middleware in order, but ONLY those with an arity of 4, ignoring regular middleware.
...
// our custom JSON 404 middleware. Since it's placed last it will be the last middleware called, if all others invoke next() and do not respond.
